...
LIBS="-lgnustl_shared" CFLAGS="$ARCHFLAGS -DU_STATIC_IMPLEMENTATION -fblocks" CPPFLAGS="$ARCHFLAGS -DU_STATIC_IMPLEMENTATION -fblocks" LDFLAGS="$ARCHLDFLAGS" ./configure \
